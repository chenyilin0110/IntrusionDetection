...
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 8:xtic(1) with histogram linestyle 7 title "NaiveBayes",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 4:xtic(1) with histogram linestyle 3 title "DNN",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 11:xtic(1) with histogram linestyle 10 title "KNN",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 5:xtic(1) with histogram linestyle 4 fillstyle pattern 6 title "DE-DNN",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 3:xtic(1) with histogram linestyle 2 title "SNDAE",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 6:xtic(1) with histogram linestyle 5 title "LSTM",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 7:xtic(1) with histogram linestyle 6 fillstyle pattern 6 title "DE-LSTM",\

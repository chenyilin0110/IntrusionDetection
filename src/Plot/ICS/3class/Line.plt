...
set xtics font ",17"
plot \
"src/Plot/ICS/3class/ICS_3class_Avg.txt" using 2:xtic(1) with linespoints linestyle 1 title "DAE",\
...
"src/Plot/ICS/3class/ICS_3class_Avg.txt" using 8:xtic(1) with linespoints linestyle 7 title "NaiveBayes",\
"src/Plot/ICS/3class/ICS_3class_Avg.txt" using 9:xtic(1) with linespoints linestyle 8 title "RandomForest",\
"src/Plot/ICS/3class/ICS_3class_Avg.txt" using 10:xtic(1) with linespoints linestyle 9 title "SVM"

...
set xtics font ",17"
plot "src/Plot/NSL-KDD-2parameters/2class/NSL-KDD-2parameters_2class_Avg-21.txt" using 2:xtic(1) with histogram linestyle 1 fillstyle pattern 6 title "DNN",\
"src/Plot/NSL-KDD-2parameters/2class/NSL-KDD-2parameters_2class_Avg-21.txt" using 3:xtic(1) with histogram linestyle 2 fillstyle pattern 6 title "HC-DNN",\
"src/Plot/NSL-KDD-2parameters/2class/NSL-KDD-2parameters_2class_Avg-21.txt" using 4:xtic(1) with histogram linestyle 3 fillstyle pattern 6 title "SA-DNN",\

...
def testing(outputLayer, train_noStringTemp_X, x_test_tensor, y_test_tensor, cuda, batchSize, datasetNumber, number):
    lstm = torch.load('src/DE_LSTM_ICS/result/DE_LSTM_' + outputLayer + '-' + datasetNumber + '_bs' + batchSize + '-' + number + '.pkl')

...
#     if name == '0':
#         torch.save(bestModel, 'src/DE_LSTM_NSL-KDD/result/DE_LSTM_' + outputLayer + '_bs' + batchSize + '-' + number + '.pkl')
#     else:
#         torch.save(bestModel, 'src/DE_LSTM_NSL-KDD/result/DE_LSTM_' + outputLayer + name + '_bs' + batchSize + '-' + number + '.pkl')

...
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 6:xtic(1) with linespoints linestyle 7 title "NaiveBayes",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 7:xtic(1) with linespoints linestyle 8 title "RandomForest",\
"src/Plot/ICS/multi/ICS_multi_Avg.txt" using 8:xtic(1) with linespoints linestyle 9 title "SVM"

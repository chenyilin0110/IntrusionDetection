...
def crossover(populationDataOriginal, mutationData, CR, Ud, Ld, Lr_Ud, Lr_Ld):
        ...
        for eachpopulationData_row in range(np.size(populationDataOriginal, 1)):
            ...
            if eachpopulationData_row == 0:
                ...
                if r <= CR:
                    crossoverPopulationData[eachpopulationData_colum][eachpopulationData_row] = \
                        mutationData[eachpopulationData_colum][eachpopulationData_row]
                if crossoverPopulationData[eachpopulationData_colum][eachpopulationData_row] > Lr_Ud:
                    crossoverPopulationData[eachpopulationData_colum][eachpopulationData_row] = Lr_Ud
                elif crossoverPopulationData[eachpopulationData_colum][eachpopulationData_row] < Lr_Ld:
                    crossoverPopulationData[eachpopulationData_colum][eachpopulationData_row] = Lr_Ld

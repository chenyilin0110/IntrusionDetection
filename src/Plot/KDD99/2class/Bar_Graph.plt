...
"src/Plot/KDD99/2class/KDD99_2class_Avg.txt" using 5:xtic(1) with histogram linestyle 4 fillstyle pattern 6 title "DE-DNN",\
...
"src/Plot/KDD99/2class/KDD99_2class_Avg.txt" using 6:xtic(1) with histogram linestyle 5 title "LSTM",\
...
"src/Plot/KDD99/2class/KDD99_2class_Avg.txt" using 7:xtic(1) with histogram linestyle 6 fillstyle pattern 6 title "DE-LSTM"
...
plot \
"src/Plot/NSL-KDD/2class/NSL-KDD_2class_Avg-21.txt" using 8:xtic(1) with histogram linestyle 7 title "NaiveBayes",\
...
"src/Plot/NSL-KDD/2class/NSL-KDD_2class_Avg-21.txt" using 6:xtic(1) with histogram linestyle 5 title "LSTM",\
"src/Plot/NSL-KDD/2class/NSL-KDD_2class_Avg-21.txt" using 3:xtic(1) with histogram linestyle 2 title "SNDAE",\
"src/Plot/NSL-KDD/2class/NSL-KDD_2class_Avg-21.txt" using 5:xtic(1) with histogram linestyle 4 fillstyle pattern 6 title "DE-DNN",\
"src/Plot/NSL-KDD/2class/NSL-KDD_2class_Avg-21.txt" using 7:xtic(1) with histogram linestyle 6 fillstyle pattern 6 title "DE-LSTM"